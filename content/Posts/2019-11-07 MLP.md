...
title: MLP from scratch with PyTorch
date: 2019-11-07
enableToc: true
---
...
What if we first apply a **fixed** non-linear transformation to the data? Consider: For some $\psi: \set{R}^d \rightarrow \set{R}^D$, what does the following classifier do?
$$
...
![[dl-tut3-overfit_1-2-4HL_3N.jpg|1100]]
